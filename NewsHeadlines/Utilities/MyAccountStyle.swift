...
public class MyAccountStyleTheme: NSObject {
    ...
    public class func apply() {
        ...
        navBarAppearance.titleTextAttributes = [NSAttributedString.Key.foregroundColor : UIColor.white, NSAttributedString.Key.font: ScaledFont.robotoSlab.font(forTextStyle: .title3)]
    }
}
